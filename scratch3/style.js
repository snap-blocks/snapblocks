  ...
  static makeCommonIcons() {
    return [
      ...
      SVG.setProps(
        SVG.group([
          SVG.el("path", {
            d: `M 6.7565 16.5218 L 6.7565 2.2698
                M 1.5116 14.2809 C 1.5116 11.3842 3.8598 9.036 6.7565 9.036 C 9.652 9.036 12.0002 11.3842 12.0002 14.2809
                M 10.9663 15.315 C 10.9663 14.7435 11.4296 14.2815 11.9998 14.2815 C 12.5725 14.2815 13.0345 14.7435 13.0345 15.315
                M 0.4775 15.315 C 0.4775 14.7435 0.9395 14.2815 1.511 14.2815 C 2.0824 14.2815 2.5457 14.7435 2.5457 15.315`,
            "stroke-width": 0.75,
            "stroke-linecap": "round",
            "stroke-linejoin": "round",
            fill: "none",
          ...
          SVG.el("path", {
            d: `M 9.6053 9.0359 L 3.906 9.0359 C 3.2035 9.0359 2.6333 8.467 2.6333 7.7631 L 2.6333 5.6364 C 2.6333 4.9339 3.2035 4.3637 3.906 4.3637 L 9.6053 4.3637 C 10.3091 4.3637 10.878 4.9339 10.878 5.6364 L 10.878 7.7631 C 10.878 8.467 10.3091 9.0359 9.6053 9.0359
                M 9.1131 14.0783 L 4.3989 14.0783 C 3.7715 14.0783 3.2624 13.5692 3.2624 12.9405 L 3.2624 12.0127 C 3.2624 10.0832 4.8266 8.519 6.756 8.519 C 8.6855 8.519 10.2497 10.0832 10.2497 12.0127 L 10.2497 12.9405 C 10.2497 13.5692 9.7406 14.0783 9.1131 14.0783
                M 7.777 16.5218 C 7.777 17.0843 7.3201 17.5425 6.7563 17.5425 C 6.1925 17.5425 5.7355 17.0843 5.7355 16.5218 C 5.7355 15.958 6.1925 15.4998 6.7563 15.4998 C 7.3201 15.4998 7.777 15.958 7.777 16.5218
                M 8.0305 2.2745 C 8.0305 2.9796 7.4603 3.5498 6.7565 3.5498 C 6.0514 3.5498 5.4813 2.9796 5.4813 2.2745 C 5.4813 1.5707 6.0514 1.0005 6.7565 1.0005 C 7.4603 1.0005 8.0305 1.5707 8.0305 2.2745`,
            stroke: "none",
          }),
          SVG.el("path", {
            d: "M 8.7564 7.404 L 4.7549 7.404 C 4.3667 7.404 4.0524 7.0896 4.0524 6.7002 C 4.0524 6.312 4.3667 5.9963 4.7549 5.9963 L 8.7564 5.9963 C 9.1458 5.9963 9.4615 6.312 9.4615 6.7002 C 9.4615 7.0896 9.1458 7.404 8.7564 7.404",
            fill: "#575e75",
            stroke: "none",
          }),
        ]),
      ...
      SVG.setProps(
        SVG.el("path", {
          d: `M 13 9.51 a 0.5 0.5 0 0 1 -0.5 0.5 H 7.197 a 0.495 0.495 0 0 0 -0.353 0.146 l -0.698 0.698 a 0.5 0.5 0 0 1 -0.353 0.146 H 4.207 a 0.5 0.5 0 0 1 -0.353 -0.146 l -0.698 -0.698 a 0.497 0.497 0 0 0 -0.353 -0.146 H 1.5 a 0.5 0.5 0 0 1 -0.5 -0.5 V 6.5 a 0.5 0.5 0 0 1 0.5 -0.5 h 1.293 a 0.5 0.5 0 0 1 0.353 0.146 l 0.708 0.708 a 0.5 0.5 0 0 0 0.353 0.146 h 1.586 a 0.5 0.5 0 0 0 0.353 -0.146 l 0.708 -0.708 A 0.5 0.5 0 0 1 7.207 6 H 12.5 a 0.5 0.5 0 0 1 0.5 0.5 z m 2 -5 a 0.5 0.5 0 0 1 -0.5 0.5 H 7.197 a 0.495 0.495 0 0 0 -0.353 0.146 l -0.698 0.698 a 0.5 0.5 0 0 1 -0.353 0.146 H 4.207 a 0.5 0.5 0 0 1 -0.353 -0.146 l -0.698 -0.698 a 0.497 0.497 0 0 0 -0.353 -0.146 H 1.5 a 0.5 0.5 0 0 1 -0.5 -0.5 V 1.5 a 0.5 0.5 0 0 1 0.5 -0.5 h 1.293 a 0.5 0.5 0 0 1 0.353 0.146 l 0.708 0.708 A 0.5 0.5 0 0 0 4.207 2 h 1.586 a 0.5 0.5 0 0 0 0.353 -0.146 l 0.708 -0.708 A 0.5 0.5 0 0 1 7.207 1 H 14.5 a 0.5 0.5 0 0 1 0.5 0.5 Z`,
          "clip-path": "evenodd",
        }),
        {
          id: "sb3-blocks",
